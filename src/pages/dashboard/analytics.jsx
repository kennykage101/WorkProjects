          ...
          <Stack spacing={3}>
            ...
            <Grid container spacing={3}>
                ...
                <RecentEvents
                  events={[
                    ...
                    },
                    {
                      id: 'EV-004',
                      type: 'purchase',
                      createdAt: dayjs().subtract(3, 'minute').valueOf(),
                      orderId: 'ORD-0068',
                    },
                    {
                      id: 'EV-003',
                      type: 'add_product',
                      createdAt: dayjs().subtract(7, 'minute').valueOf(),
                      productId: 'PRD-0016',
                    },
                    {
                      id: 'EV-002',
                    ...
                    },
                    {
                      id: 'EV-001',
                      type: 'page_view',
                      createdAt: dayjs().subtract(12, 'minute').valueOf(),
                      url: '/products/1',
                    },
                  ]}
                />
              ...
              <Grid lg={4} md={6} sx={{ '& > *': { height: '100%' } }} xs={12}>
                <TrafficBySource
                  data={[
                    { name: 'Google', value: '9.95K', icon: 'google' },
                    { name: 'Twitter', value: '4.49K', icon: 'twitter' },
                    { name: 'LinkedIn', value: '4.01K', icon: 'linkedin' },
                    { name: 'Facebook', value: '1.95K', icon: 'facebook' },
                  ]}
                />
              </Grid>
              <Grid lg={8} md={6} sx={{ '& > *': { height: '100%' } }} xs={12}>
